...
file_path = 'D:/Product duplication/textile.xlsx'
...
# Step 10: Plotting the accuracies
accuracies = {
...
plt.bar(accuracies.keys(), accuracies.values(), color=['blue', 'green', 'red', 'purple', 'orange', 'pink', 'cyan'])
plt.xlabel('Models')
plt.ylabel('Accuracy')
